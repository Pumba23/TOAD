...
# GENAUERE BERECHNUNG
def SDA_LMDI(Cct1, Cct2, Cet1, Cet2, CLt1, CLt2, Cyt1, Cyt2, m_results_x, cut):
    tag = "DLlong"
    ...
    if cut == 21:
        average_effect_f = average_effect_f[9:, 0]
        average_effect_L = average_effect_L[9:, 0]
        average_effect_y = average_effect_y[9:, 0]
    if cut == 22:
        average_effect_f = average_effect_f[9:, 1]
        average_effect_L = average_effect_L[9:, 1]
        average_effect_y = average_effect_y[9:, 1]
    if cut == 12:
        average_effect_f = average_effect_f[:9, 1]
        average_effect_L = average_effect_L[:9, 1]
        average_effect_y = average_effect_y[:9, 1]

    #average_effect_f = int(average_effect_f)
    #average_effect_L = int(average_effect_L)
    #average_effect_y = int(average_effect_y)
    ...
    m_results_x = np.vstack((average_effect_f, average_effect_L, average_effect_y)).T
