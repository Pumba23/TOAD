...
import numpy as np
from SDA_basic_DL62 import SDA_LMDI



def SDA_calc_new3(m_c_0, m_e_0, m_L_0, m_Y_0, m_c_t, m_e_t, m_L_t, m_Y_t, num_regions_0, num_sectors_0, reg_to_reg_type, pop_0, pop_t):
    ...
    if case in [7]:  # dom1
        ...
        m_results_11, tag, total = SDA_LMDI(Cct1, Cct2, Cet1, Cet2, CLt1, CLt2, Cyt1, Cyt2, m_results_11)
    ...
    if case in [1, 3, 5]:  # exports de
        ...
        m_results_21, tag, total = SDA_LMDI(Cct1, Cct2, Cet1, Cet2, CLt1, CLt2, Cyt1, Cyt2, m_results_21)
    ...
    if case in [1, 2, 3, 4]:  # dom2
        ...
        m_results_22, tag, total = SDA_LMDI(Cct1, Cct2, Cet1, Cet2, CLt1, CLt2, Cyt1, Cyt2, m_results_22)
    ...
    if case in [1, 2, 6]:  # imports DE
        ...
        m_results_12, tag, total = SDA_LMDI(Cct1, Cct2, Cet1, Cet2, CLt1, CLt2, Cyt1, Cyt2, m_results_12)
